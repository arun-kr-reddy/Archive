...
REM winget install -e --id Flow-Launcher.Flow-Launcher
REM winget install -e --id DEVCOM.JetBrainsMonoNerdFont
REM winget install -e --id WinMerge.WinMerge
REM winget install -e --id=RazerInc.RazerInstaller.Synapse4
REM winget install -e --id=HandBrake.HandBrake