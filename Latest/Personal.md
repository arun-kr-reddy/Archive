...
## Misc
- **Law of Diminishing Marginal Utility:** each additional unit consumed provides less extra satisfaction/utility than the previous unit  
  *i.e.* more you have of something, the less you value each new unit
- **Goodhart's Law:** when a measure becomes a target, it ceases to be a good measure  
  *example:* if developer is judged solely based on LLM token volume, then he will produce bloated wordy responses just to hit the target

## Quotes
- > vibecode only the things you know, or the things you don’t care about
- > I against my brothers, I & my brothers against my cousins, I & my brothers & my cousins against the world